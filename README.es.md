...
AR es un **protocolo de orquestación**: un agente principal trabaja con un revisor y un crítico, el crítico audita la revisión mediante desacuerdo estructurado antes de que el agente principal edite, y el resultado se mide por pass rate y F1 en benchmarks. disensor no orquesta ni corre modelos: define y valida el **artefacto** con el que termina cualquier ciclo de revisión, y lo aplica como gate en CI.
