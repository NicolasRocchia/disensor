...
- Conformidad del port TypeScript contra los 34 vectores de `spec/vectors` (`npm run conformidad`): mismo veredicto y mismas etiquetas de regla que la implementacion de referencia en Python, por vector.
